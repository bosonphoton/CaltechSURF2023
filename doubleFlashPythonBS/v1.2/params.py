...
def params(BS):
    ...
    param['beepOneT'] = 0.25 - param['preFlashBeepT']  # in sec
    param['beepTwoT'] = 0.25 + param['postFlashBeepT']  # in sec
...
# param.pixSize = 600/env.screenXpixels;
    ...
    circLoc[0] = (BS['leftBS_center'][0],BS['leftBS_center'][1],180)  #blind spot left
    circLoc[1] = (BS['rightBS_center'][0],BS['rightBS_center'][1],180) #blind spot right
    circLoc[2] = (env["xCenter"], env["yCenter"] + deg['fifteen'],180) #Top
    circLoc[3] = (env["xCenter"], env["yCenter"] + deg['five'],180)#top mid
    circLoc[4] = (env["xCenter"], env["yCenter"] - deg['five'],180)#Bottom mid
    circLoc[5] = (env["xCenter"], env["yCenter"] - deg['fifteen'],180)#bottom
    ...
    stim[0] = (BS['leftBS_center'][0],BS['leftBS_center'][1],180) # blind left
    stim[1] = (BS['rightBS_center'][0],BS['rightBS_center'][1],180) # blind right  
