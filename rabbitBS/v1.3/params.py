...
def params(BS):
    ...
    deg['bar_width'] = (math.tan(math.radians(0.5))/2*param['viewDist'])/param['pixSize']
    deg['bar_length'] = (math.tan(math.radians(2))/2*param['viewDist'])/param['pixSize']
...
#     orientation = 180 # vertical
    ...
    epsilon =  (math.tan(math.radians(0.01))/2*param['viewDist'])/param['pixSize'] # just to make sure it is beyond blindspot
    ...
    circLoc[1] = (BS['rightBS_center'][0] + BS['rightBS_x'] + epsilon, BS['rightBS_center'][1],180)
    #circLoc[3] = (BS['rightBS_center'][0]  + deg['one_diag'], env["yCenter"] - deg['one_diag'],45)
    circLoc[2] = (BS['rightBS_center'][0], (BS['rightBS_center'][1] - (BS['rightBS_y'] + epsilon)), 90)
    #circLoc[5] = (BS['rightBS_center'][0] - deg['one_diag'], env["yCenter"] - deg['one_diag'],-45 )
    circLoc[3] = (BS['rightBS_center'][0] - (BS['rightBS_x'] + epsilon), BS['rightBS_center'][1], 180)
    #circLoc[7] = (BS['rightBS_center'][0] - deg['one_diag'], env["yCenter"] + deg['one_diag'], 45)
    
    #For left eye (going counterclockwise)
    circLoc[4] = (BS['leftBS_center'][0], BS['leftBS_center'][1] + (BS['leftBS_y'] + epsilon), 90)
    #circLoc[9] = (BS['leftBS_center'][0]  - deg['one_diag'], BS['leftBS_center'][1] + deg['one_diag'],45)
    circLoc[5] = (BS['leftBS_center'][0] - (BS['leftBS_x'] + epsilon), BS['leftBS_center'][1],180)
    #circLoc[11] = (BS['leftBS_center'][0]  - deg['one_diag'], env["yCenter"] - deg['one_diag'],-45)
    circLoc[6] = (BS['leftBS_center'][0], BS['leftBS_center'][1] - (BS['leftBS_y'] + epsilon), 90)
    #circLoc[13] = (BS['leftBS_center'][0]  + deg['one_diag'], env["yCenter"] - deg['one_diag'],45)
    circLoc[7] = (BS['leftBS_center'][0] + (BS['leftBS_x'] + epsilon), BS['leftBS_center'][1] ,180)
    #circLoc[15] = (BS['leftBS_center'][0]  + deg['one_diag'], env["yCenter"] + deg['one_diag'],-45)        
    
    circLoc[8] = (BS['leftBS_center'][0],BS['leftBS_center'][1],180) # blind left
    circLoc[9] = (BS['rightBS_center'][0],BS['rightBS_center'][1],180) # blind right    
    ...
    sequence ={}
    stim = {}
    stim["blind_left"] = (BS['leftBS_center'][0],BS['leftBS_center'][1]) #replace with users blind spots
    stim["blind_right"] = (BS['rightBS_center'][0],BS['rightBS_center'][1]) #replace with users blind spots
    
    ############# (flashOnePos, BSpos, flashTwopos, ori)
    sequence[0] = (circLoc[0], stim["blind_right"], circLoc[2], circLoc[0][2]) #horiz
    sequence[1] = (circLoc[2], stim["blind_right"], circLoc[0], circLoc[0][2]) #horiz
    ...
    sequence[2] = (circLoc[3], stim["blind_right"], circLoc[1], circLoc[1][2]) 
    sequence[3] = (circLoc[1], stim["blind_right"], circLoc[3], circLoc[3][2])
    ...
    sequence[4] = (circLoc[4], stim["blind_left"], circLoc[6], circLoc[6][2]) #horiz
    sequence[5] = (circLoc[6], stim["blind_left"], circLoc[4], circLoc[4][2]) #horiz
    ...
    sequence[6] = (circLoc[5], stim["blind_left"], circLoc[7], circLoc[7][2])
    sequence[7] = (circLoc[7], stim["blind_left"], circLoc[5], circLoc[5][2])
