...
fileList = os.listdir("C:\\Users\\achan2\\Box\\SURF2023\\rabbitBS\\v1.3\\Data") #checks inside the data
...
if foundFiles: #check if file exists
    ...
    Data["Conditions"] = []
    Data["Responses"] = []
    Data["Responses_Location"] = [] #where did you see the second flash?
    Data["RT"] = []
...
if str(task) =='av': #40 trials, 16 catch
